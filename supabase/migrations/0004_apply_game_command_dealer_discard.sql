-- Actualiza apply_game_command (0002) para persistir también
-- awaiting_dealer_opening_discard (agregado en 0003). CREATE OR REPLACE
-- conserva los permisos ya otorgados sobre la función.
